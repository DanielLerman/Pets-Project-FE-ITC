...
const PetFormPhoto = () => {
 ...
 <div className="drop-area"{...getRootProps()}>
  <input {...getInputProps()}/>
 <span className="d-flex flex-column align-items-center p-3 "><FontAwesomeIcon style={{width:'30px', height:'30px'}} className="rounded-circle camera-icon my-3" icon={faCameraRetro}/> Drag and Drop File or Click here to upload</span></div>
